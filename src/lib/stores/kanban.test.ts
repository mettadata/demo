...
describe('kanban store', () => {
	...
	it('sync adds new todo IDs to first column', () => {
		todos.set([
			{ id: 'new-todo-1', text: 'Task 1', description: '', completed: false, createdAt: new Date().toISOString(), priority: 'none', dueDate: null, labelIds: [], activityLog: [], attachments: [] },
			{ id: 'new-todo-2', text: 'Task 2', description: '', completed: false, createdAt: new Date().toISOString(), priority: 'none', dueDate: null, labelIds: [], activityLog: [], attachments: [] }
		]);
